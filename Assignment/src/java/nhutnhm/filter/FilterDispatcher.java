...
import nhutnhm.utils.IOUtilities;
...
public class FilterDispatcher implements Filter {
    ...
    private final String ERROR_PAGE = "errors.jsp";
...
//        MAP = IOUtilities.readMapFile(path + "/Map.txt");
        ServletContext sc = req.getServletContext();
        MAP = (HashMap<String, String>) sc.getAttribute("MAPPING");
        if (MAP == null) {
            MAP = IOUtilities.readMapFile(path + "/Map.txt");
            sc.setAttribute("MAPPING", MAP);
        }
        try {
